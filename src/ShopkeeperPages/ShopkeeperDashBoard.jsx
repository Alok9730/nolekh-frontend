    ...
    <div className="w-full  h-full px-4 py-4 flex flex-col overflow-hidden">
      ...
      <div className="flex-grow  relative overflow-hidden">
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-full  sm:px-0 max-w-[90%] sm:max-w-[600px] flex items-center">
          ...
          <button className=" ml-64 absolute bottom-3 sm:right-10 sm:top-8 sm:bottom-5  w-10 h-10 sm:w-8 sm:h-8 bg-[#11aca2] rounded-full transition-all duration-200 transform hover:scale-105 hover:shadow-xl active:scale-95 hover:ring-2 hover:ring-[#3bbcb3]/60 text-white font-bold">
